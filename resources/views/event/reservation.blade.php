    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9 rounded shadow-sm p-3 my-4 bg-dark-secondary">
                <h4 class="text-center text-white py-3"><i class="fas fa-video"></i><br>Evenement Reservation Formulaire</h4>
                ...
                <form action="{{route('event.store')}}" method="POST" class="text-center">
                    @csrf
